<template>
          ...
          <div class="text-edit">
            ...
            <el-form ref="form" label-width="100px">
              ...
              <el-form-item label="字体方向：" >
                <el-select v-model="fontDir.value"
                    @change="changeFontDir"
                    placeholder="选择字体方向">
                  <el-option
                    v-for="item in fontDir"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value"
                  ></el-option>
  ...
  <!--              <ul class="template-edit" id="template-edit" @click="chooseTemplate">
        ...
        <el-aside :width="isCollapsed ? '30px' : '375px'">
          <div class="title-setting" >{{ showTitle }}</div>
          <div class="preview-box">
            <img class="preview-img" :src="imageBase64" alt="" />
          </div>
        </el-aside>
      </el-container>
    </el-container>
    ...
    export default {
      ...
      methods: {
        ...
        changeFontDir(value) {
          ...
          this.templateData.writingMode = mwritingMode;
        },
        ...
        keyDown() {
          document.onkeydown =  (e) => {
              ...
              //键盘按键判断:左箭头-37;上箭头-38；右箭头-39;下箭头-40 8:删除
              //左
              if(e1 && e1.keyCode == 37 ){
